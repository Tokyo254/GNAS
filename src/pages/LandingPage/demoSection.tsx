...
const steps = [
  {
    ...
    description:
      "Sign up in seconds. Our streamlined registration process verifies your professional identity, ensuring you join a trusted network of communicators and journalists.",
    image: signUpImage,
  },
  {
    icon: <FiEdit size={24} />,
    ...
    description:
      "Use our intuitive, full-featured editor to craft your message. Add rich content, attach files, and use the live preview to see exactly how your release will look.",
    image: editorImage,
  },
  {
    icon: <FiSend size={24} />,
    ...
    description:
      "Submit your release for review and, once approved, publish it to our network. Track its performance with our powerful analytics dashboard to measure your reach and engagement.",
    image: analyticsImage,
  },
];

const textVariants = (isOdd: boolean): Variants => ({
